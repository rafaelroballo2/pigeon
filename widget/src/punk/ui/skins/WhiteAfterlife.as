package punk.ui.skins
{
	 ...
	 */
	public class WhiteAfterlife extends PunkSkin
	{
		/**
		 * The asset to use for the skin images
		 */
		[Embed(source="white.png")] protected const I:Class;
		 ...
		 */
		public function WhiteAfterlife(roundedButtons:Boolean = true, passwordField:int = 2, textArea:int = 0, textField:int = 1, windowCaption:int = 0, windowBody:int = 0)
		{
			super();
