	...
	
{
	...
	public class LevelLabelScenario extends ScenarioEntity 	{
		...
		public function LevelLabelScenario(level:Number=1, x:Number=0, y:Number=0, graphic:Graphic=null, mask:Mask=null){
